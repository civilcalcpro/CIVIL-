...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/calculators/paint', label: 'Paint Calculator', icon: Paintbrush },
    ...
    <aside className="flex flex-col h-full bg-slate-950/80 backdrop-blur-xl border-r border-slate-800">
      <div className="p-5 border-b border-slate-800">
        <Link href="/dashboard" className="flex items-center space-x-2">
          <div className="h-9 w-9 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center">
  ...
  Follow on LinkedIn
        ...
        <div className="flex items-center justify-between px-2 py-2 rounded-lg bg-slate-900/50">
          <div className="flex items-center">
            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-cyan-500 to-cyan-700 flex items-center justify-center text-sm font-bold">
