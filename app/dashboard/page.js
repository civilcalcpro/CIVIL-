...
const quickTools = [
  ...
  name: 'RCC Design',
  icon: Building2,
  href: '/dashboard/calculators/rcc-design',
  color: 'orange',
  ...
  name: 'Quantity & Cost',
  icon: Calculator,
  href: '/dashboard/calculators/quantity-cost',
  color: 'green',
            ...
            const content = (
              <Card
                className={`group bg-slate-900/50 border-slate-800 p-5 transition-all ${
                  t.soon
                    ? 'opacity-60'
                    : 'hover:border-cyan-500/40 hover:bg-slate-900/80 cursor-pointer'
                }`}
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {!t.soon && (
                    <ArrowUpRight className="h-4 w-4 text-slate-600 group-hover:text-cyan-400 transition" />
                  )}
                </div>
